package com.hli.study.springboot.restapi.controller;
...
public class RestTemplateTestController {
	...
	@Autowired
	public RestTemplateTestController(ApiService<Map<String, Object>> apiService) {
		this.apiService = apiService;
	}
	
	@GetMapping("/test")
	public ResponseEntity<Map<String, Object>> test(@RequestParam String pageNo, @RequestParam String numOfRows, 
